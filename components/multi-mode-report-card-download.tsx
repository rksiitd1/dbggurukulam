        ...
        >
          <style jsx>{`
            ...
            @media (max-width: 768px) {
              :global(:root) {
                --scale-factor: calc(100vw / 210mm);
              }
            }
          `}</style>

          <div className="w-full h-full p-2 bg-white relative overflow-hidden" style={{ fontFamily: "serif" }}>
            {/* Decorative Border */}
            <div className="absolute inset-0 border-2 border-orange-300 m-1"></div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="text-center flex-1 mx-2">
                    <h1 className="text-2xl font-bold text-blue-900 mb-1">
                      ...
                      <span className="block text-yellow-700 text-lg font-serif font-semibold mt-1">
            ...
            {/* Mantra Section */}
            <div className="bg-yellow-50 border border-yellow-200 rounded-md py-1 px-3 mb-2 text-center max-w-2xl mx-auto">
              <div className="text-yellow-800 font-semibold leading-relaxed text-base font-serif">
            ...
            <div className="bg-orange-100 p-2 mb-2 text-center">
              <h3 className="text-lg font-bold text-blue-900 mb-1">{getExamTitle()}</h3>
              <div className="text-base font-bold text-yellow-800 mb-1 font-serif">{getDevanagariExamTitle()}</div>
              ...
              <table className="w-full border-collapse border border-gray-400 text-sm">
                <tbody>
                  <tr className="bg-gray-100">
                    <td className="border border-gray-400 p-2 font-bold text-blue-900">
                    ...
                    <td className="border border-gray-400 p-2 font-bold text-blue-900">Period / अवधि: {examPeriod}</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="mb-2">
              <h3 className="text-center text-base font-bold text-green-700 mb-2">
                ...
                <table className="w-full border-collapse border border-gray-400 text-sm">
                  <thead>
                    <tr className="bg-blue-800 text-white">
                      <th className="border border-gray-400 p-2 font-bold">Subject / विषय</th>
                    ...
                    {subjects.map((subject, index) => {
                      ...
                      return (
                        <tr key={index} className="h-8">
                          ...
                          <td className="border border-gray-400 p-2 text-center">{formatMark(marks.written)}</td>
                          <td className="border border-gray-400 p-2 text-center">{formatMark(marks.oral)}</td>
                          <td className="border border-gray-400 p-2 text-center">{formatMark(marks.project)}</td>
                          <td className="border border-gray-400 p-2 text-center font-bold">{subjectTotal}</td>
                        </tr>
                      )
                    })}
                    <tr className="bg-orange-100 h-8">
                      <td className="border border-gray-400 p-2 font-bold">TOTAL / कुल योग</td>
                      <td className="border border-gray-400 p-2 text-center font-bold">{writtenTotal}</td>
                      <td className="border border-gray-400 p-2 text-center font-bold">{oralTotal}</td>
                      <td className="border border-gray-400 p-2 text-center font-bold">{projectTotal}</td>
                      <td className="border border-gray-400 p-2 text-center font-bold">{grandTotal}</td>
                    </tr>
                    <tr className="bg-blue-100 h-8">
                      <td className="border border-gray-400 p-2 font-bold">MAXIMUM / अधिकतम</td>
                      <td className="border border-gray-400 p-2 text-center font-bold">{maxWritten}</td>
                      <td className="border border-gray-400 p-2 text-center font-bold">{maxOral}</td>
                      <td className="border border-gray-400 p-2 text-center font-bold">{maxProject}</td>
                      <td className="border border-gray-400 p-2 text-center font-bold">{maxTotal}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="mb-2">
              <div className="bg-blue-50 p-2 border border-gray-200">
                ...
                <div className="flex justify-center">
                  <table className="border-collapse border border-gray-400 w-4/5 max-w-2xl text-sm">
                    <thead>
                      <tr className="bg-orange-200">
                        <th className="border border-gray-400 p-2 font-bold">Total Marks / कुल अंक</th>
                        <th className="border border-gray-400 p-2 font-bold">Maximum Marks / अधिकतम अंक</th>
                        <th className="border border-gray-400 p-2 font-bold">Percentage / प्रतिशत</th>
                        <th className="border border-gray-400 p-2 font-bold">Grade / श्रेणी</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="h-9">
                        <td className="border border-gray-400 p-2 text-center font-bold text-lg">{grandTotal}</td>
                        <td className="border border-gray-400 p-2 text-center font-bold text-lg">{maxTotal}</td>
                        <td className="border border-gray-400 p-2 text-center font-bold text-lg">
                          {percentage.toFixed(1)}%
                        </td>
                        <td className="border border-gray-400 p-2 text-center font-bold text-xl">{grade}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <div className="mb-2">
              <table className="w-full border-collapse border border-gray-400 text-sm">
                <thead>
                  <tr className="bg-gray-100">
                    <th className="border border-gray-400 p-2 font-bold">Class Teacher / कक्षा शिक्षक</th>
                    <th className="border border-gray-400 p-2 font-bold">Date of Issue / जारी तिथि</th>
                    <th className="border border-gray-400 p-2 font-bold">Principal / प्रधानाचार्य</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
            ...
            {/* Upanishad Quote */}
            <div className="text-center mt-1 mb-1 px-2">
              <span className="text-yellow-800 font-serif text-sm leading-relaxed">
